    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNr()) {
            case 1:
                ...
                textViewQuestion.setText(currentQuestion.getOption1() + " is the correct Answer...");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText(currentQuestion.getOption2() + " is the correct Answer...");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText(currentQuestion.getOption3() + " is the correct Answer...");
                break;
        }
